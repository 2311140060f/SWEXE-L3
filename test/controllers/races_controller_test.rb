...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference("Race.count") do
      post races_url, params: { race: { date: @race.date, grade: @race.grade, location: @race.location, race_name: @race.race_name, winner: @race.winner } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { date: @race.date, grade: @race.grade, location: @race.location, race_name: @race.race_name, winner: @race.winner } }
